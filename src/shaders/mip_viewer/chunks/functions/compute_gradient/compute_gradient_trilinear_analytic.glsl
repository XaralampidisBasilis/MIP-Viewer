...
vec3 compute_gradient(in vec3 p)
{
    ...
    // Take cube samples
    float f_x0y0z0 = sampleVolume(vec3(p0.x, p0.y, p0.z));
    float f_x0y1z0 = sampleVolume(vec3(p0.x, p1.y, p0.z));
    float f_x0y0z1 = sampleVolume(vec3(p0.x, p0.y, p1.z));
    float f_x0y1z1 = sampleVolume(vec3(p0.x, p1.y, p1.z));
    float f_x1y0z0 = sampleVolume(vec3(p1.x, p0.y, p0.z));
    float f_x1y1z0 = sampleVolume(vec3(p1.x, p1.y, p0.z));
    float f_x1y0z1 = sampleVolume(vec3(p1.x, p0.y, p1.z));
    float f_x1y1z1 = sampleVolume(vec3(p1.x, p1.y, p1.z));
