...
#ifndef CIRCULAR_FILLET
#define CIRCULAR_FILLET
...
void compute_fillet_parameters (float p1x, float p1y, float p2x, float p2y, float p3x, float p3y, float p4x, float p4y, float r);
