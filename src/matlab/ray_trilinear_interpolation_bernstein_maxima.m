...
Df = Dfx * dx + Dfy * dy + Dfz * dz;

Df_t = collect( simplify( subs(Df, [x y z], [x_t, y_t, z_t]) ), t);
...
% directional derivative
Dv = Dvx * dx + Dvy * dy + Dvz * dz;

Dv_t = collect( simplify( subs(Dv, [x y z], [x_t, y_t, z_t]) ), t);
[Dv_t_coeffs, Dv_t_terms] = coeffs(Dv_t, t);
...
maxima = [
    simplify(subs(Bf0, [ax, ay, az, bx, by, bz], [0,0,0, 1,0,0])), ...
    simplify(subs(Bf0, [ax, ay, az, bx, by, bz], [0,0,0, 1,1,0])), ...
    simplify(subs(Bf0, [ax, ay, az, bx, by, bz], [0,0,0, 1,0,1])), ...
    simplify(subs(Bf0, [ax, ay, az, bx, by, bz], [0,0,0, 1,1,1])), ...
    simplify(subs(Bf0, [ax, ay, az, bx, by, bz], [0,1,0, 1,1,0])), ...
    simplify(subs(Bf0, [ax, ay, az, bx, by, bz], [0,1,0, 1,1,1])), ...
    simplify(subs(Bf0, [ax, ay, az, bx, by, bz], [0,0,1, 1,0,1])), ...
    simplify(subs(Bf0, [ax, ay, az, bx, by, bz], [0,0,1, 1,1,1])), ...    
    simplify(subs(Bf0, [ax, ay, az, bx, by, bz], [0,1,1, 1,1,1])), ...
    simplify(subs(Bf1, [ax, ay, az, bx, by, bz], [0,0,0, 1,0,0])), ...
    simplify(subs(Bf1, [ax, ay, az, bx, by, bz], [0,0,0, 1,1,0])), ...
    simplify(subs(Bf1, [ax, ay, az, bx, by, bz], [0,0,0, 1,0,1])), ...
    simplify(subs(Bf1, [ax, ay, az, bx, by, bz], [0,0,0, 1,1,1])), ...
    simplify(subs(Bf1, [ax, ay, az, bx, by, bz], [0,1,0, 1,1,0])), ...
    simplify(subs(Bf1, [ax, ay, az, bx, by, bz], [0,1,0, 1,1,1])), ...
    simplify(subs(Bf1, [ax, ay, az, bx, by, bz], [0,0,1, 1,0,1])), ...
    simplify(subs(Bf1, [ax, ay, az, bx, by, bz], [0,0,1, 1,1,1])), ...    
    simplify(subs(Bf1, [ax, ay, az, bx, by, bz], [0,1,1, 1,1,1])), ...
    simplify(subs(Bf2, [ax, ay, az, bx, by, bz], [0,0,0, 1,0,0])), ...
    simplify(subs(Bf2, [ax, ay, az, bx, by, bz], [0,0,0, 1,1,0])), ...
    simplify(subs(Bf2, [ax, ay, az, bx, by, bz], [0,0,0, 1,0,1])), ...
    simplify(subs(Bf2, [ax, ay, az, bx, by, bz], [0,0,0, 1,1,1])), ...
    simplify(subs(Bf2, [ax, ay, az, bx, by, bz], [0,1,0, 1,1,0])), ...
    simplify(subs(Bf2, [ax, ay, az, bx, by, bz], [0,1,0, 1,1,1])), ...
    simplify(subs(Bf2, [ax, ay, az, bx, by, bz], [0,0,1, 1,0,1])), ...
    simplify(subs(Bf2, [ax, ay, az, bx, by, bz], [0,0,1, 1,1,1])), ...    
    simplify(subs(Bf2, [ax, ay, az, bx, by, bz], [0,1,1, 1,1,1])), ...
    simplify(subs(Bf3, [ax, ay, az, bx, by, bz], [0,0,0, 1,0,0])), ...
    simplify(subs(Bf3, [ax, ay, az, bx, by, bz], [0,0,0, 1,1,0])), ...
    simplify(subs(Bf3, [ax, ay, az, bx, by, bz], [0,0,0, 1,0,1])), ...
    simplify(subs(Bf3, [ax, ay, az, bx, by, bz], [0,0,0, 1,1,1])), ...
    simplify(subs(Bf3, [ax, ay, az, bx, by, bz], [0,1,0, 1,1,0])), ...
    simplify(subs(Bf3, [ax, ay, az, bx, by, bz], [0,1,0, 1,1,1])), ...
    simplify(subs(Bf3, [ax, ay, az, bx, by, bz], [0,0,1, 1,0,1])), ...
    simplify(subs(Bf3, [ax, ay, az, bx, by, bz], [0,0,1, 1,1,1])), ...    
    simplify(subs(Bf3, [ax, ay, az, bx, by, bz], [0,1,1, 1,1,1])), ...
];
