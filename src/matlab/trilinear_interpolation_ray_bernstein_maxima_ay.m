...
maxima = [
    ...
    simplify(subs( Bf_t_coeffs(1), [a, b], [[1,0,1], [0,0,1]]) ), ...
    ...
    simplify(subs( Bf_t_coeffs(2), [a, b], [[1,0,1], [0,0,1]]) ), ...
    ...
    simplify(subs( Bf_t_coeffs(3), [a, b], [[1,0,1], [0,0,1]]) ), ...
    ...
    simplify(subs( Bf_t_coeffs(4), [a, b], [[1,0,1], [0,0,1]]) ), ...
];
...
% maxima_reduced(1)  = (f000 + f001 + f010)/3;
% maxima_reduced(2)  = (f001 + f010 + f011)/3;
% maxima_reduced(3)  = (f001 + f010 + f100)/3;
% maxima_reduced(4)  = (f011 + f101 + f110)/3;
% maxima_reduced(5)  = (f100 + f101 + f110)/3;
% maxima_reduced(6)  = (f101 + f110 + f111)/3;
% maxima_reduced(7)  = f000;
% maxima_reduced(8)  = f001;
% maxima_reduced(9)  = f011;
% maxima_reduced(10) = f100;
