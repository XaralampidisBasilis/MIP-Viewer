...
%% Subspace of dz/dx, dy/dx <= 1
Df_subs = simplify(subs(Df_xyz, [dx, dy, dz], [1, sy, sz]));

maxima = [
    simplify(subs(Df_subs, [r, sy, sz], [[0,0,0], [0,0]])), ...
    simplify(subs(Df_subs, [r, sy, sz], [[0,0,0], [0,1]])), ...
    simplify(subs(Df_subs, [r, sy, sz], [[0,0,0], [1,0]])), ...
    simplify(subs(Df_subs, [r, sy, sz], [[0,0,0], [1,1]])), ...
    simplify(subs(Df_subs, [r, sy, sz], [[0,0,1], [0,0]])), ...
    simplify(subs(Df_subs, [r, sy, sz], [[0,0,1], [0,1]])), ...
    simplify(subs(Df_subs, [r, sy, sz], [[0,0,1], [1,0]])), ...
    simplify(subs(Df_subs, [r, sy, sz], [[0,0,1], [1,1]])), ...
    simplify(subs(Df_subs, [r, sy, sz], [[0,1,0], [0,0]])), ...
    simplify(subs(Df_subs, [r, sy, sz], [[0,1,0], [0,1]])), ...
    simplify(subs(Df_subs, [r, sy, sz], [[0,1,0], [1,0]])), ...
    simplify(subs(Df_subs, [r, sy, sz], [[0,1,0], [1,1]])), ...
    simplify(subs(Df_subs, [r, sy, sz], [[0,1,1], [0,0]])), ...
    simplify(subs(Df_subs, [r, sy, sz], [[0,1,1], [0,1]])), ...
    simplify(subs(Df_subs, [r, sy, sz], [[0,1,1], [1,0]])), ...
    simplify(subs(Df_subs, [r, sy, sz], [[0,1,1], [1,1]])), ...
    simplify(subs(Df_subs, [r, sy, sz], [[1,0,0], [0,0]])), ...
    simplify(subs(Df_subs, [r, sy, sz], [[1,0,0], [0,1]])), ...
    simplify(subs(Df_subs, [r, sy, sz], [[1,0,0], [1,0]])), ...
    simplify(subs(Df_subs, [r, sy, sz], [[1,0,0], [1,1]])), ...
    simplify(subs(Df_subs, [r, sy, sz], [[1,0,1], [0,0]])), ...
    simplify(subs(Df_subs, [r, sy, sz], [[1,0,1], [0,1]])), ...
    simplify(subs(Df_subs, [r, sy, sz], [[1,0,1], [1,0]])), ...
    simplify(subs(Df_subs, [r, sy, sz], [[1,0,1], [1,1]])), ...
    simplify(subs(Df_subs, [r, sy, sz], [[1,1,0], [0,0]])), ...
    simplify(subs(Df_subs, [r, sy, sz], [[1,1,0], [0,1]])), ...
    simplify(subs(Df_subs, [r, sy, sz], [[1,1,0], [1,0]])), ...
    simplify(subs(Df_subs, [r, sy, sz], [[1,1,0], [1,1]])), ...
    simplify(subs(Df_subs, [r, sy, sz], [[1,1,1], [0,0]])), ...
    simplify(subs(Df_subs, [r, sy, sz], [[1,1,1], [0,1]])), ...
    simplify(subs(Df_subs, [r, sy, sz], [[1,1,1], [1,0]])), ...
    simplify(subs(Df_subs, [r, sy, sz], [[1,1,1], [1,1]])), ...
];
