...
maxima = [
    ...
    simplify(subs( maxima_terms(1), [a, b], [[0,1,0], [0,1,0]]) ), ...
    simplify(subs( maxima_terms(1), [a, b], [[0,1,0], [0,1,1]]) ), ...
    simplify(subs( maxima_terms(1), [a, b], [[0,1,0], [1,1,1]]) ), ...
    simplify(subs( maxima_terms(1), [a, b], [[1,1,0], [1,1,0]]) ), ...
    simplify(subs( maxima_terms(1), [a, b], [[1,1,0], [1,1,1]]) ), ...
    simplify(subs( maxima_terms(1), [a, b], [[0,0,1], [0,0,1]]) ), ...
    simplify(subs( maxima_terms(1), [a, b], [[0,1,1], [0,1,1]]) ), ...
    ...
    simplify(subs( maxima_terms(2), [a, b], [[0,1,0], [0,1,0]]) ), ...
    simplify(subs( maxima_terms(2), [a, b], [[0,1,0], [0,1,1]]) ), ...
    simplify(subs( maxima_terms(2), [a, b], [[0,1,0], [1,1,1]]) ), ...
    simplify(subs( maxima_terms(2), [a, b], [[1,1,0], [1,1,0]]) ), ...
    simplify(subs( maxima_terms(2), [a, b], [[1,1,0], [1,1,1]]) ), ...
    simplify(subs( maxima_terms(2), [a, b], [[0,0,1], [0,0,1]]) ), ...
    simplify(subs( maxima_terms(2), [a, b], [[0,1,1], [0,1,1]]) ), ...
    ...
    simplify(subs( maxima_terms(3), [a, b], [[0,1,0], [0,1,0]]) ), ...
    simplify(subs( maxima_terms(3), [a, b], [[0,1,0], [0,1,1]]) ), ...
    simplify(subs( maxima_terms(3), [a, b], [[0,1,0], [1,1,1]]) ), ...
    simplify(subs( maxima_terms(3), [a, b], [[1,1,0], [1,1,0]]) ), ...
    simplify(subs( maxima_terms(3), [a, b], [[1,1,0], [1,1,1]]) ), ...
    simplify(subs( maxima_terms(3), [a, b], [[0,0,1], [0,0,1]]) ), ...
    simplify(subs( maxima_terms(3), [a, b], [[0,1,1], [0,1,1]]) ), ...
...
% maxima_reduced(2)  = (f001 + f010 + f100)/3 - f000;
% maxima_reduced(3)  = (f001 + f100 + f101)/3 - f000;
% maxima_reduced(4)  = (f011 + f101 + f110)/3 - f000;
% maxima_reduced(5)  = (f011 + f110 + f111)/3 - f010;
% maxima_reduced(6)  = (f101 + f110 + f111)/3 - f100;
% maxima_reduced(7)  = (f001 + f010 + f000)/3 - f000;
% maxima_reduced(8)  = (f001 + f100 + f000)/3 - f000;
% maxima_reduced(9)  = (f011 + f110 + f010)/3 - f010;
% maxima_reduced(10) = (f101 + f110 + f100)/3 - f100;
% maxima_reduced(11) = f001 - f000;
% maxima_reduced(12) = f011 - f000;
% maxima_reduced(13) = f011 - f010;
% maxima_reduced(14) = f101 - f000;
% maxima_reduced(15) = f111 - f000;
% maxima_reduced(16) = f111 - f010;
% maxima_reduced(17) = f101 - f100;
% maxima_reduced(18) = f111 - f100;
% maxima_reduced(19) = f111 - f110;
