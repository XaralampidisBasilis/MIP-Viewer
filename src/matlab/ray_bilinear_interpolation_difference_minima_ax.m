...
minima = [
    simplify(subs( minima_terms(1), [a, b], [[0,0], [1,0]]) ), ...
    simplify(subs( minima_terms(1), [a, b], [[0,0], [1,1]]) ), ...
    simplify(subs( minima_terms(1), [a, b], [[0,1], [1,1]]) ), ...
];
...
fprintf('\nReduced symbolic maxima minima_reduced:\n');
disp(minima_reduced);
