...
% maxima_reduced( 7) = (f011 + f110 + f010)/3 - f010;
% maxima_reduced( 8) = (f001 - f000);
% maxima_reduced( 9) = (f101 - f000);
% maxima_reduced(10) = (f011 - f000);
% maxima_reduced(11) = (f011 - f010);
% maxima_reduced(12) = (f111 - f000);
% maxima_reduced(13) = (f111 - f010);