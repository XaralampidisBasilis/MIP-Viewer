...
export default class OcclusionMap
{
    ...
    async computeTensor()
    {
        ...
        // const t1 = OCC.computeExtendedAnisotropicBidirectionalOcclusionMap(this.volumeMap.tensor, true)
        // const t2 = OCC.computeExtendedAnisotropicBidirectionalOcclusionMapDeprecated(this.volumeMap.tensor, true)
