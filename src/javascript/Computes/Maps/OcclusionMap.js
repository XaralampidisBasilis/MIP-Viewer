...
// import { computeOcclusionMap as f} from '../Programs/GPGPUOcclusionMapDiff'
import { computeOcclusionMap as f} from '../Programs/GPGPUOcclusionMap'
...
export default class OcclusionMap
{
    ...
    async computeTensor()
    {
        ...
        this.tensor = f(this.volumeMap.tensor)
