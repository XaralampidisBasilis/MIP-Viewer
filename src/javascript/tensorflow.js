...
export function setTensorflowFlags()
{
    ...
    tf.env().set("WEBGL_DELETE_TEXTURE_THRESHOLD", 0) // -1, 0, 8, 16, 32, 64, 128, 512 * 512 * 512 (bytes) : avoid gpu memory buildup and reuse
    tf.env().set('WEBGL_FLUSH_THRESHOLD', 0.01) // -1, 1 (ms) : avoid unnecessary flush overhead 
}
